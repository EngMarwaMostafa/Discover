...
import '../../../../bookings2/presentation/views/widgets/custom_book_button.dart';
    ...
    void languageAlert(BuildContext context) {
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(AppStrings.arabic,style: AppTextStyle.text14W500Black(context),),
                                    ],
                                  ),
                                  Row(
                                    children: [
                                      ...
                                      Text(AppStrings.english,style: AppTextStyle.text14W500Black(context),),
                                    ],
                                  ),
                                  SizedBox(height: 3.h,),
                                  CustomBookButton(
