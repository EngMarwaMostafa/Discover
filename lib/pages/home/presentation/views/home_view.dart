          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  OscillateText(AppStrings.offers, style: AppTextStyle.text16W600Black(context),
                    textDirection: TextDirection.rtl,),
                  SizedBox(width:24.w,),
                  Text(AppStrings.all,style: AppTextStyle.text14Decoration(context)),
                ],
              ),
            ),
            Padding(
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  OscillateText(AppStrings.places,style: AppTextStyle.text16W600Black(context),
                      textDirection: TextDirection.rtl,
                  ),
                  SizedBox(width: 20.w,),
                  InkWell(
                    onTap: (){
                      ...
                      child: Text(AppStrings.all,style: AppTextStyle.text14Decoration(context))),
                ],
              ),
            ),
            Padding(
            ...
            Padding(
              ...
              mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  OscillateText(AppStrings.famous,style: AppTextStyle.text16W600Black(context),
                    textDirection: TextDirection.rtl,
                  ),
                  SizedBox(width:18.w,),
                  Text(AppStrings.all,style: AppTextStyle.text14Decoration(context)),
